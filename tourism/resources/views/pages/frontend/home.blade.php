            ...
            <div class="row justify-content-center section-popular-content">
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="card-travel text-center d-flex flex-column"
                        style="background-image: url('{{ $travelPackage->firstTravelGallery ? $travelPackage->firstTravelGallery->getImage() : asset('assets/frontend/images/travel/original/pop1.jpg') }}');">
