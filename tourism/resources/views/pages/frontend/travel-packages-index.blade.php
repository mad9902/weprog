                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                            <div class="card-travel-list text-center d-flex flex-column"
                                style="background-image: url('{{ $travelPackage->firstTravelGallery ? $travelPackage->firstTravelGallery->getImage() : asset('https://st3.depositphotos.com/23594922/31822/v/600/depositphotos_318221368-stock-illustration-missing-picture-page-for-website.jpg') }}');">
